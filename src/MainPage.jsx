    ...
    <>
      <div className="bg-red-900 h-screen">
        <div>
          ...
          <p className="text-center text-white">Click on the parking lot you are in, then click the spot you are taking up</p>
          <br /><br />
          ...
          <map name="campusMap">
            ...
            <ParkingArea id="speed" shape="rect" coords="490, 455, 575, 555" href="../testPage.html" label="Speed Lot" labelStyle={{ top: '650px', left: '650px' }} />
            <ParkingArea id="hatfield" shape="rect" coords="930, 370, 965, 435" href="../testPage.html" label="Hatfield Lot" labelStyle={{ top: '600px', left: '950px' }} />
            <ParkingArea id="bic" shape="rect" coords="760, 120, 825, 175" href="../testPage.html" label="BIC/KIC Lot" labelStyle={{ top: '265px', left: '820px' }} />
            <ParkingArea id="commuter" shape="rect" coords="1265, 90, 1365, 150" href="../testPage.html" label="Commuter Lot :(" labelStyle={{ top: '300px', left: '1300px' }} />
            <ParkingArea id="src" shape="rect" coords="550, 120, 730, 175" href="../testPage.html" label="SRC Lot" labelStyle={{ top: '255px', left: '600px' }} />
          </map>
        </div>
      </div>
    </>
